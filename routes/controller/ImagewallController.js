...
var ImagewallController = (function () {
    function ImagewallController() {
    }
    ImagewallController.getRouter = function () {
    ...
    return ImagewallController;
})();
module.exports = ImagewallController.getRouter();
